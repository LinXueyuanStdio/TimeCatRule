...
dependencies {
    //region project
    runtimeOnly rootProject.ext.timecat["module-reader"]
...
1. 发布为 aar，通过`runtimeOnly rootProject.ext.timecat["module-book-reader"]`。
...
databinding 需要 implementation api, 不能 runtimeOnly